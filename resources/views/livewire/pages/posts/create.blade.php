            ...
            <form wire:submit.prevent="store" class="flex-1 pb-10">
                <div>
                    <textarea 
                        ...
                        wire:model="content" 
                        rows="5" 
                        class="block w-full border-none bg-transparent focus:ring-0 resize-none text-xl p-0 placeholder-gray-500 text-gray-900" 
                ...
                <div class="mt-6 border-t border-gray-100 pt-4 flex justify-between items-center">
                    <div class="flex items-center gap-2">
                        <label for="media" class="cursor-pointer p-2 rounded-full text-indigo-500 hover:bg-indigo-50 transition" title="Add Media">
